...
This module contains an extension providing Minecraft version release notifications and lookup commands, based on
Mojang's launcher metadata.
...
* **Maven coordinates:** `dev.kordex.modules:func-minecraft:VERSION`

To manually add the module to your project, follow these steps:

1. Add the module to your project.
	- `dev.kordex.modules:func-minecraft:VERSION`
